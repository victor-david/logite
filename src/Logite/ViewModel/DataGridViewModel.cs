...
namespace Restless.Logite.ViewModel
{
    ...
    public abstract class DataGridViewModel<T> : ApplicationViewModel where T : TableBase
    {
        ...
        //private readonly DataView mainTableView;
        #endregion
        ...
        {
            get => selectedDataGridItems != null && SelectedItem != null && selectedDataGridItems.Count == 1;
        }
        ...
        {
            get => selectedDataGridItems != null && selectedDataGridItems.Count > 1;
        }
        ...
        protected DataGridViewModel() : base()
        {
