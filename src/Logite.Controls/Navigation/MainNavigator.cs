...
namespace Restless.Logite.Controls
{
    ...
    /// </summary>
    public class MainNavigator : ListBox
    {
        #region Private
        ...
        public static readonly DependencyProperty IconBrushProperty = DependencyProperty.Register
            (
                nameof(IconBrush), typeof(Brush), typeof(MainNavigator), new PropertyMetadata()
                {
        ...
        {
            Visibility =
                Items.OfType<NavigatorItem>().Where((n) => n.IsItemVisible).Any() ?
                Visibility.Visible :
